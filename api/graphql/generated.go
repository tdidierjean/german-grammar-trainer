...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Exercise.answer":
		if e.complexity.Exercise.Answer == nil {
			break
		}

		return e.complexity.Exercise.Answer(childComplexity), true

	case "Exercise.hint":
		if e.complexity.Exercise.Hint == nil {
			break
		}

		return e.complexity.Exercise.Hint(childComplexity), true
	...
	case "Query.exerciseTypes":
		...
		return e.complexity.Query.ExerciseTypes(childComplexity), true
...
func (ec *executionContext) _Exercise_question(ctx context.Context, field graphql.CollectedField, obj *Exercise) (ret graphql.Marshaler) {
...
func (ec *executionContext) _Exercise_hint(ctx context.Context, field graphql.CollectedField, obj *Exercise) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _Exercise_answer(ctx context.Context, field graphql.CollectedField, obj *Exercise) (ret graphql.Marshaler) {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
...
func (ec *executionContext) _Query_exerciseTypes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().ExerciseTypes(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Exercise(ctx context.Context, sel ast.SelectionSet, obj *Exercise) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "hint":
			out.Values[i] = ec._Exercise_hint(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "answer":
			out.Values[i] = ec._Exercise_answer(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "translations":
