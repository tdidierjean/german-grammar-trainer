...
func (r *queryResolver) Exercises(ctx context.Context, count *int, exerciseType *string, withTranslations *bool) ([]*Exercise, error) {
	...
	rawExercises, err := exerciseGenerator.GetExercises([]string{*exerciseType}, *count, *withTranslations)
